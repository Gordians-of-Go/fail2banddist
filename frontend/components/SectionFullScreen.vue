...
import { gradientBgPurplePink, gradientBgDark, gradientBgPinkRed, gradientBgBlue } from '@/configs/colors.js'

const props = defineProps({
  bg: {
    type: String,
    required: true,
    validator: (value) => ['purplePink', 'pinkRed', 'blue'].includes(value)
  }
})
